# openSUSE with Java and Tomcat images

This project builds on the openSUSE Java image [here](https://github.com/CAFapi/opensuse-base-images) to build pre-configured Tomcat Docker images
