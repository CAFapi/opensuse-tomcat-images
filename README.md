...
This project builds on the openSUSE Java 17 image [here](https://github.com/CAFapi/opensuse-base-images/tree/main/opensuse-java17-images) to build two pre-configured Tomcat Docker images
